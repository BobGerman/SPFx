...
import * as strings from 'webPackKoStrings';
import WebPackKoViewModel, { IWebPackKoBindingContext } from './WebPackKoViewModel';
import { IWebPackKoWebPartProps } from './IWebPackKoWebPartProps';

let _instance: number = 0;

export default class WebPackKoWebPart extends BaseClientSideWebPart<IWebPackKoWebPartProps> {
  private _id: number;
  ...
  protected onInit(): Promise<void> {
    ...
    const bindings: IWebPackKoBindingContext = {
